...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        Path absoluto2 = Paths.get("/urs/local");
        Path absoluto3 = Paths.get("/home/william/devdojofoda/OlaMundo.java");
        Path relatvo1 = Paths.get("temp");
        Path relatvo2 = Paths.get("temp/temp.2021921");

        System.out.println("1 "+absoluto1.relativize(absoluto3));
        System.out.println("2 "+absoluto3.relativize(absoluto1));
        System.out.println("3 "+absoluto1.relativize(absoluto2));
        System.out.println("4 "+relatvo1.relativize(relatvo2));
        System.out.println("5 "+absoluto1.relativize(relatvo1));
    }
}
